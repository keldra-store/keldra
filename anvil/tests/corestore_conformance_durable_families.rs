...
fn rfc_0006_no_durable_bypass_feature_families_are_corestore_backed() {
    let families = [
        ...
        DurableFeatureFamily {
            ...
            required_terms: &[
                "BucketJournalBody",
                "stage_bucket_mutation_in_transaction",
                "build_bucket_mvcc_mutation_plan",
            ],
            corestore_terms: &[
                "product_mutations_and_outbox_from_operations",
                "stage_product_mutations",
                ".add_stream_event(",
        ...
        DurableFeatureFamily {
            ...
            required_terms: &[
                "AuthzTuple",
                "write_authz_tuple",
                "stage_authz_tuple_batch_with_permit",
            ],
            corestore_terms: &[
                "coremeta_logical_key",
                "ProductMutation::put",
        ...
        DurableFeatureFamily {
            ...
            required_terms: &[
                ...
                "rebuild_routing_record_projection_from_payload_mvcc",
    ...
    assert!(
        failures.is_empty(),
        "durable feature families must persist through certified MVCC/CoreStore paths; failures={failures:#?}"
    );
}
