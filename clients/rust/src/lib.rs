...
pub mod proto {
    ...
    pub use super::generated::{
        ...
        GetHfIngestionStatusResponse, GetLatestPersonalDbProjectionSnapshotRequest,
        GetObjectRequest, GetObjectResponse, GetPackageVersionRequest, GetPartitionMapRequest,
        GetPersonalDbGroupRequest, GetPersonalDbProjectionRequest, GetStorageClassRequest,
        GetTensorChunk, GetTensorRequest, GetTensorsRequest, GetTransactionRequest,
        ...
        IndexMaintenanceMode, IndexPolicySnapshotMode, IndexQueryHit, InitiateMultipartRequest,
        ...
        PersonalDbProjectionResponse, PersonalDbProjectionSnapshotDescriptor,
        PersonalDbProjectionSnapshotFrame, PersonalDbProjectionSnapshotRequest,
        PersonalDbSnapshotsHeadRecord, PersonalDbVoterAck, PublicMutationContext,
        PutAuthzSchemaRequest, PutAuthzSchemaResponse, PutBoundarySchemaRequest,
        PutBucketPolicyRequest, PutBucketPolicyResponse, PutCellRequest, PutGitPackRequest,
        PutGitPackResponse, PutModelManifestRequest, PutModelManifestResponse, PutNodeRequest,
        PutObjectRequest, PutObjectResponse, PutPackageBlobRequest, PutPackageVersionRequest,
        PutRegionRequest, PutRegistryRefRequest, QueryIndexRequest, QueryIndexResponse,
        QuerySpecRequest, QuerySpecResponse, ReadAppendStreamRequest, ReadAppendStreamResponse,
        ReadAuthzTuplesRequest, ReadAuthzTuplesResponse, ReadConsistency, ReadObjectLinkRequest,
        ReadTaskLeaseRequest, ReadTaskLeaseResponse, RepairAuthzDerivedIndexRequest,
        RepairAuthzDerivedIndexResponse, RepairDirectoryIndexRequest, RepairDirectoryIndexResponse,
        RepairFindingRecord, RepairIndexRequest, RepairIndexResponse,
        RepairPersonalDbLogChainRequest, RepairPersonalDbLogChainResponse, RepairSubjectRecord,
        RevokeAccessRequest, RevokeAccessResponse, RollbackTransactionRequest,
        RollbackTransactionResponse, RotateApplicationCredentialSecretRequest,
        SealAppendStreamSegmentRequest, SealAppendStreamSegmentResponse, SetPublicAccessRequest,
        SetPublicAccessResponse, StartBoundaryMigrationRequest, StartHfIngestionRequest,
        StartHfIngestionResponse, StorageClassDescriptor, StorageClassResponse,
        ...
        TenantScope, TensorIndexRow, TransactionStatus, UpdateIndexRequest,
        ...
        WatchPrefixResponse, WatchVisibilityMode, WriteAuthzTupleRequest, WriteAuthzTupleResponse,
