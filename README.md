...
```sh
export ANVIL_IMAGE=ghcr.io/worka-ai/anvil:0.8.1
...
```sh
cargo add anvil-storage@0.8.1 personaldb-protocol@0.2.2 serde_json
```
...
```sh
ANVIL_IMAGE=ghcr.io/worka-ai/anvil:0.8.1 \
