...
use keldra_api::v1::personal_db_service_server::PersonalDbService;
use keldra_api::v1::{
...
use keldra_authz::{AuthorizationCheck, ObjectRef, Tuple};
...
fn projection_definition(
    ...
    definition: Option<keldra_api::v1::PersonalDbMirrorProjectionDefinition>,
...
fn role_operation_id(
    ...
    let mut hasher = blake3::Hasher::new_derive_key("keldra.personaldb/role-operation/v1");
...
mod pagination_tests {
    ...
    const FIRST_VISIBLE: &str =
        "_keldra/personaldb/v1/64617461626173652d31/67726f75702d31/manifest.json";
    const SECOND_VISIBLE: &str =
        "_keldra/personaldb/v1/64617461626173652d32/67726f75702d32/manifest.json";
