...
pub(crate) use model::{
    ...
    StoredTrafficCheckpoint, StoredTrafficSource, current_path, definition_path,
    derive_accounting_id, includes_path, is_accounting_path, is_accounting_source_change,
    is_artifact_path, outbound_source_path, validate_prefix,
};
