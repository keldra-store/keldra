...
use keldra_store::{BlobRef, Durability, ErasureProfile, SMALL_BLOB_MAX_BYTES};
use thiserror::Error;
...
mod tests {
    ...
    fn small_weighted_vector_is_frozen_and_input_order_independent() {
        ...
        assert_eq!(small_owners(first), [53, 61, 29]);
        assert_eq!(small_owners(reversed), [53, 61, 29]);
    }
