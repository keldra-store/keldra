...
const GRPC_SERVICE_PATHS: &[&str] = &[
    "/keldra.v1.ObjectService/",
    "/keldra.v1.AuthzService/",
    "/keldra.v1.IndexService/",
    "/keldra.v1.AccountingService/",
    "/keldra.v1.CredentialService/",
    "/keldra.v1.AdministrationService/",
    "/keldra.v1.PersonalDbService/",
];
    ...
    fn grpc_wire_shape_selects_only_registered_services() {
        for content_type in [
            ...
            let request = request(
                Method::POST,
                Version::HTTP_2,
                "/keldra.v1.ObjectService/GetObject",
                content_type,
            );
