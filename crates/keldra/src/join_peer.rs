...
pub(crate) struct JoinActivationPermit {
    ...
    _lease_pause: Option<keldra_consensus::ServingLeaseGrantPause>,
...
impl JoinActivationPermit {
    pub(crate) fn after_handoff(
        ...
        pause: keldra_consensus::ServingLeaseGrantPause,
...
pub(crate) struct JoinPeerService {
    ...
    pins: Arc<dyn keldra_consensus::CommittedPeerPinProvider>,
...
impl wire::join_peer_server::JoinPeer for JoinPeerService {
    ...
    async fn activate(
        ...
        if descriptor.state == NodeState::Joining {
            ...
            let advanced = self
                .decisions
                .submit(keldra_consensus::Command::CompleteMembershipTransition {
