...
use crate::object_service::request_auth::authenticated_caller;
use crate::object_service::routed_writes;
...
pub(super) fn linked_put_fingerprint(link: &ObjectKey, publish: &PublishRequest) -> [u8; 32] {
    let mut hasher = blake3::Hasher::new_derive_key("keldra.put-through-object-link/v1");
