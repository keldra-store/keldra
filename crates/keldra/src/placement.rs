...
const HASH_CONTEXT: &str = "keldra.storage/weighted-hrw/v1";
...
mod tests {
    ...
    fn score_and_ranking_vectors_are_frozen() {
        let cluster = ClusterId(*b"keldra-cluster-1");
        let key = b"tenant/42/bucket/7/object/path";

        let vectors = [
            (
                1,
                804_080_501_961_544_730_u64,
                83_377_114_619_068_998_958_u128,
            ),
            (
                2,
                2_469_630_723_405_156_639_u64,
                53_513_985_299_863_223_301_u128,
            ),
            (
                17,
                10_179_592_051_073_176_808_u64,
                15_821_522_453_827_852_732_u128,
            ),
            (
                1_023,
                15_719_971_805_786_696_630_u64,
                4_256_910_249_986_659_681_u128,
            ),
        ];
        ...
        assert_eq!(ids(ranked), [1_023, 17, 2, 1]);
    }
    ...
    fn configured_weight_controls_deterministic_distribution() {
        ...
        assert_eq!(
            counts,
            BTreeMap::from([(1, 14_246), (2, 28_653), (3, 7_101)])
        );
    }
