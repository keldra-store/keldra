...
use keldra_store::{SYSTEM_STORAGE_TENANT_ID, Store, SystemBootstrapRequest, SystemBootstrapState};
use serde::{Deserialize, Serialize};
use uuid::Uuid;

const CREDENTIAL_SCHEMA: &str = "keldra.system-bootstrap-credential.v1";
