...
enum AuthzServiceError {
    ...
    Evaluation(keldra_authz::AuthorizationError),
}
...
impl From<keldra_authz::AuthorizationError> for AuthzServiceError {
    fn from(value: keldra_authz::AuthorizationError) -> Self {
...
pub(super) fn binding_to_api(binding: &keldra_store::RealmBinding) -> api::SchemaBinding {
    api::SchemaBinding {
...
mod tests {
    ...
    use keldra_authz::{RealmId, TupleSubject};
    use keldra_store::{AuthzScope, Store, StoreOptions, SystemBootstrapRequest};
            ...
            .get_binding(request(
                ...
                api::GetBindingRequest {
                    scope: Some(api::AuthzScope {
                        storage_tenant: keldra_store::SYSTEM_STORAGE_TENANT_ID.into(),
                        realm: keldra_authz::SYSTEM_REALM_ID.into(),
                    }),
                },
            ))
            .await
