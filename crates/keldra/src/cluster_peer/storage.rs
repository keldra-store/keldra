...
impl wire::cluster_peer_server::ClusterPeer for ClusterPeerService {
    ...
    ) -> Result<Response<keldra_api::v1::PersonalDbGroup>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::PersonalDbGroupRoleChange>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::PersonalDbCommit>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::PersonalDbMaterialization>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::PersonalDbSnapshot>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::AccountingDefinition>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::DisableAccountingResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::AccountingSnapshot>, Status> {
                ...
                bounded_blocking(visibility_remaining(deadline)?, move || {
                    ...
                    let page = store
                        .scan_routed_local_changes(
                            keldra_store::JournalRoute::Bucket {
                                tenant_id,
                                bucket_id,
                            },
                            expected_source,
    ...
    ) -> Result<Response<keldra_api::v1::BulkWriteResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::PutSchemaResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::BindSchemaResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::GetBindingResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::GetSchemaResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::MutateTuplesResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::ReadTuplesResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::CheckPermissionResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::CheckPermissionsResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::BucketPolicy>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::DeleteVersionResponse>, Status> {
    ...
    ) -> Result<Response<keldra_api::v1::InvokeProgramResponse>, Status> {
...
pub(super) fn object_coordinator(
    ...
    bucket_id: u64,
    path: &str,
) -> Option<keldra_consensus::NodeId> {
    placement
        .rank(
            PlacementKind::Object,
...
fn proof_matches_path(
    ...
    match &proof.change {
        keldra_store::LocalChange::ObjectHead(change) => {
            change.tenant_id == tenant_id
                && change.bucket_id == bucket_id
                && change.exact_path == exact_path
        }
        keldra_store::LocalChange::RetainedVersionDeleted(change) => {
            change.tenant_id == tenant_id
                && change.bucket_id == bucket_id
                && change.exact_path == exact_path
        }
...
fn require_local_source(
    local_node: keldra_consensus::NodeId,
...
fn routed_watch_status(error: keldra_store::RoutedJournalError) -> Status {
    match error {
        keldra_store::RoutedJournalError::CursorExpired { .. }
        | keldra_store::RoutedJournalError::SourceEpochMismatch
        | keldra_store::RoutedJournalError::SourceNodeMismatch => {
            Status::out_of_range("RESUME_EXPIRED")
        }
        keldra_store::RoutedJournalError::InvalidLimits
        | keldra_store::RoutedJournalError::TargetBeforeCursor { .. }
        | keldra_store::RoutedJournalError::TargetFuture { .. } => {
            Status::invalid_argument(error.to_string())
        }
        keldra_store::RoutedJournalError::CursorFuture { .. }
        | keldra_store::RoutedJournalError::MissingPrimary { .. }
        | keldra_store::RoutedJournalError::RouteMismatch { .. }
        | keldra_store::RoutedJournalError::Storage(_) => Status::data_loss(error.to_string()),
    }
}
...
pub(super) fn list_page_from_wire(page: wire::LocalListPage) -> Result<OwnedListPage, Status> {
    ...
    Ok(OwnedListPage::new(
        keldra_consensus::NodeId(page.source_node_id),
        PlacementLogId {
