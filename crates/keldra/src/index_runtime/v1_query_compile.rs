//! Checked public-protobuf translation for the storage-neutral v1 executor.
...
use keldra_index::typed_json::{
    ...
    OrderDirection, OrderField, Predicate, PredicateId, RangeBound, ScalarValue, TypedJsonSchema,
};
...
pub(crate) struct CompiledV1Query {
...
pub(crate) fn compile_v1_query(
    schema: &TypedJsonSchema,
    query: &IndexQuery,
) -> Result<CompiledV1Query, IndexError> {
    schema.validate()?;
