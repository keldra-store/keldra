...
fn project_analyzed_values(
    field: &keldra_index::v4::FieldSchema,
    values: &[ScalarValue],
    terms: &mut Vec<ProjectedTerm>,
    lengths: &mut Vec<(FieldId, u32)>,
) -> Result<(), IndexError> {
...
fn vector_field(schema: &Schema) -> Result<&keldra_index::v4::FieldSchema, IndexError> {
    schema
        .fields
        .iter()
...
fn normalize(value: keldra_index::v4::VectorNormalization) -> bool {
    value == keldra_index::v4::VectorNormalization::L2
}
