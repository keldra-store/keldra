...
use keldra_api::v1::{ProvisionTenantRequest, SetBucketPublicReadRequest};
use keldra_store::{ErasureProfile, StorageTenantId, Store, StoreOptions, SystemBootstrapRequest};
use tempfile::TempDir;
use tokio::io::{AsyncReadExt as _, AsyncWriteExt as _};
use tonic::Request;
use tonic::transport::{Channel, Endpoint};

const SIGNING_KEY: &[u8] = b"keldra-s3-gateway-qualification-signing-key";
...
fn test_server_config(
    ...
    ServerConfig {
        ...
        rocksdb_resources: keldra_store::RocksDbResourceBudget::default(),
        ...
        single_node_group_commit: keldra_store::SingleNodeGroupCommitConfig::default(),
    }
}
