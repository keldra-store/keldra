...
pub const SYSTEM_REALM_ID: &str = "_keldra/system";
pub const PERSONALDB_REALM_ID: &str = "_keldra-personaldb";
pub const PUBLIC_SUBJECT_NAMESPACE: &str = "app";
pub const PUBLIC_SUBJECT_ID: &str = "_keldra/public";
/// Reserved non-credentialed application identity used at the public service
/// boundary when a request omits authentication.
pub const ANONYMOUS_SUBJECT_ID: &str = "_keldra/anonymous";
...
///
/// `default` and `_keldra/system` are valid persisted realm IDs. Callers that
