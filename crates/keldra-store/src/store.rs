...
impl MutationBackpressureWait {
    fn start(capacity: &'static str) -> Self {
        tracing::info!(
            capacity,
            counter.keldra_mutation_backpressure_waiting = 1_i64,
            monotonic_counter.keldra_mutation_backpressure_waits_total = 1_u64,
    ...
    fn emit(&self, outcome: &'static str, cancelled: bool) {
        ...
        tracing::info!(
            ...
            monotonic_counter.keldra_mutation_backpressure_wait_cancellations_total =
                u64::from(cancelled),
            histogram.keldra_mutation_backpressure_wait_duration_seconds =
...
fn receipt_key(identity: BucketIdentity, command_id: &str) -> Vec<u8> {
    ...
    hasher.update(b"keldra.mutation-receipt-key.v1");
