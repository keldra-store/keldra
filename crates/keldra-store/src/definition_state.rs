...
pub enum DefinitionConsumerKind {
    ...
    /// All-source v1 catalog feed checkpoint. It advances only after the
...
impl DefinitionConsumerKind {
    pub fn definition_kind(self) -> DefinitionKind {
        match self {
            Self::IndexAssignments | Self::V1IndexCatalog => DefinitionKind::Index,
