use anvil_api::v1::PersonalDbGroupKind as ApiGroupKind;
...
pub(crate) const MANIFEST_ROOT_PREFIX: &str = "_anvil/personaldb/v1/";
...
pub(super) fn storage_command_id(scope: &GroupScope, command_id: &str, operation: &str) -> String {
    let mut hasher = blake3::Hasher::new_derive_key("anvil.personaldb/storage-command/v1");
