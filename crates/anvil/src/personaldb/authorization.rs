...
const SCHEMA_ID: &str = "_anvil-personaldb-v1";
...
pub(super) fn role_relation(role: anvil_api::v1::PersonalDbGroupRole) -> &'static str {
    match role {
        anvil_api::v1::PersonalDbGroupRole::Reader => "reader",
        anvil_api::v1::PersonalDbGroupRole::Writer => "writer",
        anvil_api::v1::PersonalDbGroupRole::Materializer => "materializer",
        anvil_api::v1::PersonalDbGroupRole::Manager => "manager",
        anvil_api::v1::PersonalDbGroupRole::Unspecified => unreachable!("role was validated"),
    }
}
...
fn require_expected_binding(
    ...
    expected: &anvil_store::SchemaRef,
) -> Result<RealmBinding, Status> {
