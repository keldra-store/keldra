...
use anvil_consensus::{ClusterId, NodeDescriptor, NodeId, NodeState, PeerAddress, StateMachine};
...
#[cfg(test)]
mod tests {
    use anvil_consensus::{CapabilityRange, JoinCapabilityHash, PeerSpkiSha256};
