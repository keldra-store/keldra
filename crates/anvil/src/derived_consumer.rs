...
impl DerivedCheckpointPublisher {
    ...
    pub(crate) async fn publish(
        ...
        let span = tracing::info_span!(
            "anvil.derived_consumer.checkpoint",
            consumer.kind = kind,
        ...
        span.in_scope(|| {
            tracing::info!(
                consumer.kind = kind,
                counter.anvil_derived_checkpoint_publish_active = 1_i64,
                monotonic_counter.anvil_derived_checkpoint_publish_attempts_total = 1_u64,
        ...
        span.in_scope(|| {
            ...
            tracing::info!(
                ...
                monotonic_counter.anvil_derived_checkpoint_publish_failures_total =
                    u64::from(result.is_err()),
                histogram.anvil_derived_checkpoint_publish_duration_seconds = elapsed_seconds,
    ...
    pub(crate) async fn fence_local_source(&self) -> Result<(), Status> {
        let started = std::time::Instant::now();
        let span = tracing::info_span!(
            "anvil.derived_consumer.membership_fence",
        ...
        span.in_scope(|| {
            tracing::info!(
                ...
                monotonic_counter.anvil_derived_fence_attempts_total = 1_u64,
                monotonic_counter.anvil_derived_fence_failures_total = u64::from(result.is_err()),
                histogram.anvil_derived_fence_duration_seconds = elapsed_seconds,
