...
pub(super) async fn compact_oldest_prefix(
    ...
    let span = tracing::info_span!(
        "anvil.index.locator_compaction",
    ...
    tracing::info!(
        ...
        histogram.anvil_index_locator_compaction_duration_seconds = elapsed,
        monotonic_counter.anvil_index_locator_compaction_input_bytes_total = input_encoded_bytes,
        monotonic_counter.anvil_index_locator_compaction_output_bytes_total = published.encoded_bytes,
        monotonic_counter.anvil_index_locator_compactions_total = 1_u64,
