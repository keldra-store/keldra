//! Bounded reads of v1 component runs embedded in content-addressed delta packs.
...
/// pack. The complete pack hash binds every selected byte; structural identity
/// and record count are checked while decoding the selected range.
