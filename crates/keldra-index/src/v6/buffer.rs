...
const SEGMENT_MAGIC: &[u8; 8] = b"K6DELTA1";
...
impl ProjectionMutationBuffer {
    ...
    /// transactional clone. Batch callers should use the in-place operation on
    /// an already isolated transaction buffer.
...
mod tests {
    use super::*;
    use crate::v6::{CanonicalRecipeState, ProjectedDocumentState};
