...
pub use store::{
    ...
    MAX_REFERENCE_PROOF_PRUNE_BYTES, MAX_REFERENCE_PROOF_PRUNE_RECORDS, MutationReceiptRetention,
    ...
    ReferenceProofPage, ReferenceProofPruneError, ReferenceProofPruneResult, ShardIdentity,
