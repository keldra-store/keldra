...
impl PrefetchMetrics {
    fn emit(self) {
        tracing::info!(
            monotonic_counter.anvil_store_bulk_prefetch_head_keys_total = self.head_keys,
            monotonic_counter.anvil_store_bulk_prefetch_version_keys_total = self.version_keys,
            monotonic_counter.anvil_store_bulk_prefetch_receipt_keys_total = self.receipt_keys,
            monotonic_counter.anvil_store_bulk_prefetch_blob_reference_keys_total =
                self.blob_reference_keys,
            monotonic_counter.anvil_store_bulk_prefetch_small_blob_keys_total =
                self.small_blob_keys,
            monotonic_counter.anvil_store_bulk_prefetch_policy_keys_total = self.policy_keys,
            monotonic_counter.anvil_store_bulk_prefetch_versioning_keys_total =
                self.versioning_keys,
            histogram.anvil_store_bulk_prefetch_heads_duration_seconds = self.head_seconds,
            histogram.anvil_store_bulk_prefetch_versions_duration_seconds = self.version_seconds,
            histogram.anvil_store_bulk_prefetch_receipts_duration_seconds = self.receipt_seconds,
            histogram.anvil_store_bulk_prefetch_blob_references_duration_seconds =
                self.blob_reference_seconds,
            histogram.anvil_store_bulk_prefetch_small_blobs_duration_seconds =
                self.small_blob_seconds,
            histogram.anvil_store_bulk_prefetch_policies_duration_seconds = self.policy_seconds,
            histogram.anvil_store_bulk_prefetch_versioning_duration_seconds =
