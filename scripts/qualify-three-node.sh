...
requested_image="${ANVIL_IMAGE:-anvil:0.9.2}"
...
if [[ "${server_version}" != "anvil-server 0.9.2" \
  || "${client_version}" != "anvil 0.9.2" ]]; then
  echo "qualification requires the exact Anvil 0.9.2 image" >&2
