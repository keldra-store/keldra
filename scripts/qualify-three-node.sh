...
requested_image="${ANVIL_IMAGE:-anvil:0.8.1}"
...
if [[ "${server_version}" != "anvil-server 0.8.1" \
  || "${client_version}" != "anvil 0.8.1" ]]; then
  echo "qualification requires the exact Anvil 0.8.1 image" >&2
