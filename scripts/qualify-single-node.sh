...
requested_image="${KELDRA_IMAGE:-keldra:0.17.1}"
...
if [[ "${server_version}" != "keldra-server 0.17.1" \
  || "${client_version}" != "keldra 0.17.1" ]]; then
  echo "qualification requires the exact Keldra 0.17.1 image" >&2
