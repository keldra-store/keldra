...
requested_image="${KELDRA_IMAGE:-keldra:0.12.0}"
...
if [[ "${server_version}" != "keldra-server 0.12.0" \
  || "${client_version}" != "keldra 0.12.0" ]]; then
  echo "qualification requires the exact Keldra 0.12.0 image" >&2
