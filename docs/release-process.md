...
`RUSTUP_TOOLCHAIN=1.96.0` and top-level `rust_codegen_backend: "llvm"`, lock
...
ARM64 release image with top-level `rust_codegen_backend: "llvm"`. The same contract can select
