...
pub use meta::{
    ...
    TABLE_OBJECT_WATCH_CURSOR_ROW, TABLE_OBSERVABILITY_CURSOR_ROW, TABLE_OWNERSHIP_FENCE_ROW,
    TABLE_PARTITION_OWNER_ROW, TABLE_PENDING_MUTATION_ROW, TABLE_PERSONALDB_DATA_LOCATOR_ROW,
    TABLE_PERSONALDB_GROUP_ROW, TABLE_PERSONALDB_PROPOSAL_CLAIM_ROW,
    ...
    TABLE_QUORUM_PROFILE_CURRENT_ROW, TABLE_REFCOUNT_ROW, TABLE_REGISTRY_BLOB_LOCATOR_ROW,
    TABLE_REGISTRY_VERSION_ROW, TABLE_REPAIR_FINDING_HEAD_ROW, TABLE_REPAIR_FINDING_ID_ROW,
    TABLE_REPAIR_FINDING_ROW, TABLE_ROOT_CACHE_ROW, TABLE_ROOT_CATALOG_CURRENT_ROW,
    TABLE_ROOT_FAILOVER_CERTIFICATE_ROW, TABLE_ROOT_FAILOVER_VOTE_ROW, TABLE_STREAM_HEAD_ROW,
    TABLE_STREAM_IDEMPOTENCY_ROW, TABLE_STREAM_RECORD_INDEX_ROW, TABLE_SYSTEM_BOOTSTRAP_MARKER_ROW,
    TABLE_TASK_CURRENT_ROW, TABLE_TASK_LEASE_ROW, TABLE_TRANSACTION_COMMIT_EVIDENCE_ROW,
    TABLE_TRANSACTION_LOCATOR_ROW, TABLE_TRANSACTION_MANIFEST_BODY_ROW, TABLE_WATCH_CHECKPOINT_ROW,
    TABLE_WRITER_HEAD_ROW, TABLE_WRITER_SEGMENT_ROW, canonical_coremeta_cf_name,
