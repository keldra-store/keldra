...
impl AdminService for AppState {
    async fn create_tenant(
        ...
        self.create_tenant_admin(request).await
    }
    ...
    async fn create_application(
        ...
        self.create_application_admin(request).await
    }
    ...
    async fn rotate_application_secret(
        ...
        self.rotate_application_secret_admin(request).await
    }
    ...
    async fn grant_application_policy(
        ...
        self.grant_application_policy_admin(request).await
    }
    ...
    async fn revoke_application_policy(
        ...
        self.revoke_application_policy_admin(request).await
    }
