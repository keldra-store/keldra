...
#[path = "operations_helpers.rs"]
mod operations_helpers;
use operations_helpers::authoritative_boundary_generation_hash;
...
impl AppState {
    ...
    pub(super) async fn index_page_token_boundary_hash(
        ...
        let tuple_key =
            crate::core_store::CoreStore::boundary_schema_current_tuple_key(&bucket_key)
